...
void runCalculations(const InitialValueProblemParams<Type>& problemParams) {
    ...
    parametersInput >> method_id >> precisionParams.tau0 >> precisionParams.tol >> precisionParams.eps >> useStepRegulation;
    ...
    if (method_id == 0){
        ...
        rungeKuttaMethod(problemParams, rkParams, useStepRegulation, precisionParams, OUTPUT_FILE_NAME);
        ...
        symmetricalSchemeMethod(problemParams, precisionParams, OUTPUT_FILE_NAME);

    }  else if (method_id == 5) {
        adamsBashfort4Method(problemParams, precisionParams, OUTPUT_FILE_NAME);

    }  else if (method_id == 6) {
        ab4PredictorCorrectorMethod(problemParams, precisionParams, OUTPUT_FILE_NAME);
